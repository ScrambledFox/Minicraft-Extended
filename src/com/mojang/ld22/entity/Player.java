...
import com.mojang.ld22.item.Map;
...
public class Player extends Mob {
	...
	public static int mapExploreRange = 250;
...
//		for(int yt = 10; yt < level.w - 10; yt++) {
//			for(int xt = 10; xt < level.h - 10; xt++) {
//				level.explored[xt + yt * level.w] = 0;
//				level.exploreTile(xt, yt);
//				level.explored[xt + yt * level.w] = 0;
//			}
//		}
		
		for(int yt = -mapExploreRange / 2; yt < mapExploreRange / 2; yt++) {
			for(int xt = -mapExploreRange / 2; xt < mapExploreRange / 2; xt++) {
				level.exploreTile((x + xt) >> 4, (y + yt) >> 4);
			}
		}
