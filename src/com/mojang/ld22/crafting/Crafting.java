...
public class Crafting {
	...
	static {
		try {
			...
			workbenchRecipes.add(new ItemRecipe(Map.class).addCost(Resource.cloth, 10).addCost(Resource.cactusFlower, 1).addCost(Resource.coal, 1).addCost(Resource.bone, 1));
